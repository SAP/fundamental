<template>
  <footer class="fd-footer" id="footer" role="contentinfo">
    <div class="fd-footer__left">
      ...
      <div class="fd-footer__left-libraries">
        ...
        <a
          ...
          target="_blank"
          hreflang="en"
          >Fundamental Styles</a
        >
        <a
          href="https://sap.github.io/fundamental-ngx/fundamental-ngx#/core/home"
          rel="noopener noreferrer"
          target="_blank"
          hreflang="en"
          >Fundamental NGX</a
        >
        <a
          href="https://sap.github.io/fundamental-ngx/fundamental-ngx#/platform/home"
          rel="noopener noreferrer"
          target="_blank"
          hreflang="en"
          >Fundamental Platform</a
        >
      </div>
      ...
      <div class="fd-footer__left-resources">
        <p>Resources</p>
        <a
          href="https://community.sap.com/search/?ct=blog&q=fundamental+library"
          rel="noopener noreferrer"
          target="_blank"
          hreflang="en"
          >SAP Blog</a
    ...
    <div class="fd-footer__right">
      ...
      <img
        alt="SAP logo"
        src="@/assets/images/SAP_Best_R_grad_blk_scrn.avif"
        class="fd-sap-logo"
      />
      <img
        alt="SAP logo"
